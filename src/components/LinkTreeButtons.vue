      ...
      <v-responsive>
        <v-row align="center">
          <v-btn
            ...
            :elevation="24"
          >
            <v-icon>mdi-web</v-icon>Portfolio
          </v-btn>
          <v-btn
            class="my-2"
          ...
          <v-btn
            class="my-2"
            href="https://www.youtube.com/channel/UCie15qtPU-1ajeYsygddJuQ?view_as=subscriber"
            target="_blank"
            dark
            x-large
            block
